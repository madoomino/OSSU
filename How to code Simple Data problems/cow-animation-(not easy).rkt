...
;; A cow animation goes back and forth across all of the screen.
...
(define (render-cow c)
  (place-image (choose-cow c) (cow-x c) CTR-Y MTS ))

;; Cow -> Image
;; produce RCOW or LCOW depending on direction cow is going; LCOW if dx = 0
(check-expect (choose-cow (make-cow 10 3)) RCOW)
(check-expect (choose-cow (make-cow 11 -3)) LCOW)
